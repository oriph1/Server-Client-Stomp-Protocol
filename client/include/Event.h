...
public:
    ...
    Event(std::deque<std::string> &spilted);
    virtual ~Event();
    ...
    //for the new contructor
    void setEventName(std::deque<std::string> &spilted);
    void setTeamAName(std::deque<std::string> &spilted);
    void setTeamBName(std::deque<std::string> &spilted);
    void setTime(std::deque<std::string> &spilted);
    void set_General_Game_Updates(std::deque<std::string> &spilted);
    void set_Team_A_Updates(std::deque<std::string> &spilted);
    void set_Team_B_Updates(std::deque<std::string> &spilted);
    void set_discription(std::deque<std::string> &spilted);
};
